...
public class MarsikParser extends Parser {
	...
	public static final int
		...
		RULE_return_stmt = 21, RULE_print_stmt = 22, RULE_exit_stmt = 23, RULE_scan_stmt = 24, 
		RULE_arguments = 25, RULE_expr = 26, RULE_or_expr = 27, RULE_and_expr = 28, 
		RULE_equality_expr = 29, RULE_relational_expr = 30, RULE_additive_expr = 31, 
		RULE_multiplicative_expr = 32, RULE_unary_expr = 33, RULE_power_expr = 34, 
		RULE_atom_expr = 35, RULE_class_def = 36, RULE_class_member = 37, RULE_field_decl = 38, 
		RULE_method_decl = 39;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"for_stmt", "for_init", "for_update", "return_stmt", "print_stmt", "exit_stmt", 
			"scan_stmt", "arguments", "expr", "or_expr", "and_expr", "equality_expr", 
	...
	public final Exit_stmtContext exit_stmt() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_exit_stmt);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Equality_exprContext equality_expr() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_equality_expr);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Relational_exprContext relational_expr() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_relational_expr);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Additive_exprContext additive_expr() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_additive_expr);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final Multiplicative_exprContext multiplicative_expr() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_multiplicative_expr);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Power_exprContext power_expr() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_power_expr);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Class_memberContext class_member() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_class_member);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Field_declContext field_decl() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_field_decl);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Method_declContext method_decl() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_method_decl);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{

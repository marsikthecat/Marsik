...
public interface MarsikListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MarsikParser#println_stmt}.
	 * @param ctx the parse tree
	 */
	void enterPrintln_stmt(MarsikParser.Println_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link MarsikParser#println_stmt}.
	 * @param ctx the parse tree
	 */
	void exitPrintln_stmt(MarsikParser.Println_stmtContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MarsikParser#print_arg}.
	 * @param ctx the parse tree
	 */
	void enterPrint_arg(MarsikParser.Print_argContext ctx);
	/**
	 * Exit a parse tree produced by {@link MarsikParser#print_arg}.
	 * @param ctx the parse tree
	 */
	void exitPrint_arg(MarsikParser.Print_argContext ctx);
	/**

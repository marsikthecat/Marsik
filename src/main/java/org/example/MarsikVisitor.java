...
public interface MarsikVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MarsikParser#build_in_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBuild_in_stmt(MarsikParser.Build_in_stmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MarsikParser#printLn_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrintLn_stmt(MarsikParser.PrintLn_stmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MarsikParser#time_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTime_stmt(MarsikParser.Time_stmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link MarsikParser#other_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOther_stmt(MarsikParser.Other_stmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MarsikParser#constructor_decl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstructor_decl(MarsikParser.Constructor_declContext ctx);
	/**
